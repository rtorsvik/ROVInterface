...
namespace Avionics
{
	class HeadingIndicatorInstrumentControl : InstrumentControl
	{
		...
		// Images
		Bitmap bmpCadran = new Bitmap(Avionics.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.HeadingIndicator_Background);
		Bitmap bmpHedingWeel = new Bitmap(Avionics.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.HeadingWeel);
		Bitmap bmpAircaft = new Bitmap(Avionics.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.HeadingIndicator_Aircraft);
