partial class WindowStatus
    {
        ...
        0F};
			...
			this.btn_graphicsloaded.TabIndex = 7;
			this.btn_graphicsloaded.Text = "load";
			this.btn_graphicsloaded.UseVisualStyleBackColor = true;
			this.btn_graphicsloaded.Click += new System.EventHandler(this.btn_graphicsloaded_Click);
			// 
			...
			this.txtbox_graphicsloaded.TabIndex = 5;
			// 
			// btn_ExportSettings
			// 
			...
			this.txtbox_dllimported.TabIndex = 4;
			// 
			// lab_DLLimported
			// 
